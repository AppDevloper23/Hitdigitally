            ...
            <main className="main-wrapper">
                ...
                <div className="offcanvas offcanvas-start" tabIndex="-1" id="toggleMenu">
                    <div className="offcanvas-header">
                        ...
                        <a href="index.html" className="header-logo"><img src="/assets/images/logo/logo.png" alt="" /></a>
                        ...
                        <div className="offcanvas-mobile-menu-wrapper">
                            ...
                            <div className="mobile-contact-info text-center">
                                <ul className="social-link">
                                    <li><a href="https://example.com/"><i className="icofont-facebook"></i></a>
                                    </li>
                                    <li><a href="https://example.com/"><i className="icofont-twitter"></i></a>
                                    </li>
                                    <li><a href="https://example.com/"><i className="icofont-skype"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
